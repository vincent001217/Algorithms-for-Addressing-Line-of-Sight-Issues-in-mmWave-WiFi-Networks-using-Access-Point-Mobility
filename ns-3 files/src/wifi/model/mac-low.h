...
//  void ResumeTransmission (bool overrideDuration, Time duration, MacLowTransmissionListener *listener);
   ...
   */
  // Yubing
  void SetBeaconTxFlag (bool beaconTxFlag);
  void UpdateMcsMap (void);
  void UpdateMCSAndRSSHistory (WifiMode mode);
   ...
   */
  Time CalculateDmgTransactionDuration (Ptr<Packet> packet, WifiMacHeader &hdr) const;
