...
public:
  ...
  // Yubing
  void SetModeBasedOnRxSensitivity (Mac48Address address, WifiMode mode);
...
private:
  ...
  // Yubing
  virtual void DoSetDataMode (Mac48Address address, WifiMode mode) = 0;
  virtual void DoSetControlMode (Mac48Address address, WifiMode mode) = 0;
