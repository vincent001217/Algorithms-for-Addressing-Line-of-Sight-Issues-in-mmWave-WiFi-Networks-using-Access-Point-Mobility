...
private:
   ...
   */
  Ptr<InterferenceHelper::Event> Add (WifiTxVector txVector, Time duration, double rxPowerW);
  /**
   ...
   */
  double CalculatePlcpTrnSnr (Ptr<InterferenceHelper::Event> event);
  /**
...
private:
   ...
   */
  std::pair<double,double> CalculateChunkSuccessRate (double snir, Time duration, WifiMode mode, WifiTxVector txVector) const;
  /**
   ...
   */
  std::pair<double,double> CalculatePlcpPayloadPer (Ptr<const Event> event, NiChanges *ni) const;
  /**
